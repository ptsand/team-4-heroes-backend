package kea.group4.backend.security.jwt;


import kea.group4.backend.repositories.PersonRepository;
import kea.group4.backend.security.UserDetailsImp;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    public JwtTokenFilter(JwtTokenUtil jwtTokenUtil, PersonRepository userRepository) {
